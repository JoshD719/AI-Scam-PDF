...
The npm registry may be blocked in some environments, and Playwright is optional. The current recommended method is browser export from the standalone print-ready HTML file.
...
Use this file for Chrome Save as PDF export.
...
1. Build or confirm the print HTML exists: `dist/2026-Family-AI-Scam-Defense-Kit-PRINT.html`.
